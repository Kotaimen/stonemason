# -*- coding: utf-8 -*-
#
# stonemason documentation build configuration file, created by
...
release = __import__('stonemason').__version__
...
html_theme_options = {
    'logo': 'logo.png',
    'github_user': 'Kotaimen',
    'github_repo': 'stonemason',
    'github_button': False,
    'travis_button': False,
}
